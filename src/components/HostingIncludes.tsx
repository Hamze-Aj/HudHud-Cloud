...
const features = [
    ...
    {
        icon: <Zap className="w-6 h-6 text-white" strokeWidth={1.8} />,
        title: "SSD Storage",
        subtitle: "Lightning-fast performance",
    },
    {
        icon: <Server className="w-6 h-6 text-white" strokeWidth={1.8} />,
        title: "Enterprise Hardware",
        subtitle: "Top-tier infrastructure",
    },
    {
        icon: <CheckCircle className="w-6 h-6 text-white" strokeWidth={1.8} />,
        title: "Free Migration",
        subtitle: "We handle the transfer",
    },
];
...
export default function HostingIncludes() {
    return (
                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <div className="w-14 h-14 rounded-full flex items-center justify-center mb-5"
                                style={{
                                    background: "linear-gradient(135deg, #7b3fa0 0%, #c0395a 60%, #e05c30 100%)"
                                }}
                            >
                                {feature.icon}
                            </div>
