...
const features = [
    { col: 0, text: "Student enrollment & records" },
    { col: 1, text: "Attendance tracking" },
    { col: 0, text: "Grade & exam management" },
    { col: 1, text: "Parent-teacher communication" },
    { col: 0, text: "Timetable scheduling" },
    { col: 1, text: "Fee management" },
];

const leftFeatures = features.filter((f) => f.col === 0);
const rightFeatures = features.filter((f) => f.col === 1);
...
export default function SaaSEMS() {
    return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-12 h-12 bg-orange-50 rounded-xl flex items-center justify-center border border-orange-100 shrink-0">
                                <GraduationCap className="w-6 h-6 text-[#ff5733]" strokeWidth={1.8} />
                            </div>
                            <div>
                        ...
                        <p className="text-slate-700 text-base mb-7 leading-relaxed">
                            Complete school and{" "}
                            <span className="text-[#ff5733] font-semibold">university</span>{" "}
                            management platform
                        </p>
                            ...
                            {pricingPlans.map((plan) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className={`font-bold text-base ${plan.popular ? "text-slate-900" : "text-slate-900"}`}>
                                                {plan.name}
                                            </p>
                                        ...
                                        <span className={`font-extrabold text-lg ${plan.custom ? "text-[#ff5733]" : "text-[#ff5733]"}`}>
                                            {plan.price}
                                        </span>
                                    </div>
                                </div>
