                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center border border-slate-200 shrink-0">
                                <ShoppingBag className="w-6 h-6 text-[#1E1F8B]" strokeWidth={1.8} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-extrabold text-slate-900 leading-none">POS System</h3>
                                <p className="text-sm text-slate-500 mt-0.5">Point of Sale System</p>
                            </div>
                        </div>

                        <p className="text-slate-700 text-base mb-7 leading-relaxed">
                            Modern cloud-based point of sale solution
                        </p>
                            ...
                            {pricingPlans.map((plan) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="font-extrabold text-lg text-[#1E1F8B]">{plan.price}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
